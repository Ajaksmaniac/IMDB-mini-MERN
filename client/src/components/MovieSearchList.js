...
export default class MovieSearchList extends Component{
    ...
    findAllMovies(){
        ...
        if(params.trim() == "") {
            ...
            axios.get("http://localhost:1337/api/movie/name/"+params)
                       ...
                       <Table bordered hover striped variant="dark">
                           ...
                           {this.state.movies.length === 0 ?
                               ...
                               this.state.movies.map((movie) =>(
                                    <tr key={movie.movie_id}  onClick={() => this.fetchDetails(movie)}>
                                        ...
                                        <td>
                                            <ButtonGroup>
                                                ...
                                                <Button size="sm" variant="outline-danger" onClick={() => this.deleteMovie(movie.movie_id)}><FontAwesomeIcon icon={faTrash} /></Button>
                                            </ButtonGroup>
                                        </td>
